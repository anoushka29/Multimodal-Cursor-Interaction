...
document.getElementById("startMouseControlButton").addEventListener("click", startMouseControl);


// Function to start mouse control
function startMouseControl() {
    // Call the backend function to start mouse control
    eel.startMouseControl();
}
